...
# SB: IRSTLM was installed in /speech/misc/debeersa and the path was updated in path.sh
...
local/score.sh --min-lmwt 1 --max-lmwt 20 data/dev exp/mono/graph exp/mono/decode_dev

steps/decode.sh --skip-scoring true --nj "$decode_nj" --cmd "$decode_cmd" \
 exp/mono/graph data/test exp/mono/decode_test

local/score.sh --min-lmwt 1 --max-lmwt 20 data/test exp/mono/graph exp/mono/decode_test
...
local/score.sh --min-lmwt 1 --max-lmwt 20 data/dev exp/tri1/graph exp/tri1/decode_dev

steps/decode.sh --skip-scoring true --nj "$decode_nj" --cmd "$decode_cmd" \
 exp/tri1/graph data/test exp/tri1/decode_test

local/score.sh --min-lmwt 1 --max-lmwt 20 data/test exp/tri1/graph exp/tri1/decode_test
