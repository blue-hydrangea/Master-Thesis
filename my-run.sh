...
local/timit_data_prep.sh /speech/db/eng_US/LVCSR/LDC/TIMIT_LDC93S1/package/timit/TIMIT
...
for x in train dev test; do
  steps/make_mfcc.sh --nj 10 data/$x $mfccdir
...
steps/train_mono.sh  --nj 30 data/train data/lang exp/mono

utils/mkgraph.sh data/lang_test_bg exp/mono exp/mono/graph

steps/decode.sh --nj 5 exp/mono/graph data/dev exp/mono/decode_dev

steps/decode.sh --nj 5 exp/mono/graph data/test exp/mono/decode_test

steps/score_kaldi.sh data/dev exp/mono/graph exp/mono/decode_dev

steps/score_kaldi.sh data/test exp/mono/graph exp/mono/decode_test

echo ============================================================================
echo "           tri1 : Deltas + Delta-Deltas Training & Decoding               "
echo ============================================================================

steps/align_si.sh --boost-silence 1.25 --nj 10 data/train data/lang exp/mono exp/mono_ali

# Train tri1, which is deltas + delta-deltas, on train data.

steps/train_deltas.sh 2500 15000 data/train data/lang exp/mono_ali exp/tri1

utils/mkgraph.sh data/lang_test_bg exp/tri1 exp/tri1/graph

steps/decode.sh --nj 5 exp/tri1/graph data/dev exp/tri1/decode_dev

steps/decode.sh --nj 5 exp/tri1/graph data/test exp/tri1/decode_test

steps/score_kaldi.sh data/dev exp/tri1/graph exp/tri1/decode_dev

steps/score_kaldi.sh data/test exp/tri1/graph exp/tri1/decode_test
...
steps/decode.sh --nj 5 exp/tri2/graph data/dev exp/tri2/decode_dev

steps/decode.sh --nj 5 exp/tri2/graph data/test exp/tri2/decode_test

steps/score_kaldi.sh data/dev exp/tri2/graph exp/tri2/decode_dev

steps/score_kaldi.sh data/test exp/tri2/graph exp/tri2/decode_test
...
steps/align_si.sh --nj 10 --use-graphs true data/train data/lang exp/tri2 exp/tri2_ali
...
steps/decode_fmllr.sh --nj 5 exp/tri3/graph data/dev exp/tri3/decode_dev

steps/decode_fmllr.sh --nj 5 exp/tri3/graph data/test exp/tri3/decode_test

steps/score_kaldi.sh data/dev exp/tri3/graph exp/tri3/decode_dev

steps/score_kaldi.sh data/test exp/tri3/graph exp/tri3/decode_test
